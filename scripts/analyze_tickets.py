...
STATS_THEME_CSS = """
    /* Shared high-contrast site theme */
    :root {
      --bg: #070910;
      --bg-soft: #0e0e10;
      --panel: #111620;
      --panel-alt: #111620;
      --line: rgba(245, 245, 246, 0.22);
      --ink: #f5f5f6;
      --muted: #c7cad2;
      --dark-ink: #070910;
      --accent: #9ec1f5;
      --accent-soft: rgba(158, 193, 245, 0.16);
      --success: #8ce0b3;
    ...
    body {
      ...
      background:
        radial-gradient(circle at 12% 0%, rgba(70, 111, 176, 0.16), transparent 28rem),
        radial-gradient(circle at 88% 8%, rgba(80, 160, 122, 0.10), transparent 26rem),
        var(--bg);
      overscroll-behavior-y: none;
    }
    .page {
    ...
    .eyebrow {
      min-height: 32px;
      padding: 6px 11px;
      border: 1px solid rgba(245, 245, 246, 0.22);
      background: #111620;
      color: var(--muted);
      font-size: 0.78rem;
      font-weight: 700;
    ...
    .hero-link {
      min-height: 44px;
      padding: 10px 15px;
      border: 1px solid rgba(245, 245, 246, 0.28);
      background: #111620;
      color: var(--ink);
      font-weight: 600;
    ...
    .hero-link:hover {
      transform: none;
      border-color: rgba(245, 245, 246, 0.58);
      background: #18202d;
    }
    .hero-link.primary,
    ...
    .kpi {
      min-width: 0;
      padding: 15px 16px;
      border: 1px solid rgba(245, 245, 246, 0.20);
      border-radius: 14px;
    ...
    .insight::after {
      height: 3px;
      background: linear-gradient(90deg, var(--tone, var(--accent)), transparent 86%);
      opacity: 0.72;
    }
    .kpi-label {
      min-height: 2.4em;
...
def render_stats_html(
    *,
    ...
    root_badge = "Technical request analytics" if root_mode else "Export-specific analytics"
...
<body>
  <main class="page">
    <section class="hero">
      ...
      <p>Operational overview of request volume, workload mix, delivery risk, and discussion activity across the laboratories.</p>
      <nav aria-label="Site navigation" class="hero-links">{hero_links_html}</nav>
